...
const Login = () => {
  ...
  const navpage = ()=>{
    if (values.password === values.confirmPassword) {
        ...
        useEffect(()=>{
            setTimeout(()=>loginPage('/user-home-page/sign-in'),3000)
        },[])
      }
  }
      ...
      <div className="container sign">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form container ui">
            ...
            <button className="fluid blue" onClick={navpage}>Submit</button>
          </div>
        </form>

        <div className="text">
          Already have an account? <span className=" text-info"> <a href="/user-home-page/sign-in">Login</a></span>
        </div>
      </div>{" "}
      <Captcha />
    </>
