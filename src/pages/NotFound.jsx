...
import { FaArrowAltCircleLeft, FaExclamationTriangle, FaPage4 } from 'react-icons/fa';
...
<h1 className="fw-bold h1" ><FaExclamationTriangle className="divtag"/> Error <span className='page404'>404</span></h1>
